  ...
  return (
    <div className={styles.container}>
      ...
      <div className={styles.content}>
        ...
        <h4 className={cn("body-bold", styles.title)}>{text}</h4>
